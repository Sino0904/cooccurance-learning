...
parser.add_argument('--load_symm', default='', type=str, metavar='PATH',help='path to latest checkpoint (default: none)')
...
def get_model():
    model = models.init_model(name=args.arch, num_classes=79, pretrained = None,model_load=args.load_symm,use_gpu=use_gpu)
    model = model.cuda()
