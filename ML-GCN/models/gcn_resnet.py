...
# def resnet50(num_classes, pretrained='imagenet', **kwargs):
#     model = ResNet(
...
# def resnet101(num_classes, pretrained='imagnet', **kwargs):
#     model = ResNet(
#         num_classes = num_classes,
#         block=Bottleneck,
#         layers=[3, 5, 23, 3],
...
def gcn_resnet50(num_classes, t, pretrained='imagnet', adj_file=None, in_channel=300, **kwargs):
    model = ResNet(
        num_classes=num_classes,
        block=Bottleneck,
        layers=[3, 4, 6, 3],
