...
def main():
    ...
    if not args.test:
        ...
        train_dataset = DatasetLoader_semantics(args.data, img_set='train', annotation=os.path.join('/srv/data1/ashishsingh/Half_and_Half_Data/I2L/annotation', 'antisymm_multilabel_nofreq_trainset_annotation.json'), inp_name='./Image_to_Label/baselines/ML-GCN/data/coco/hnh_glove_word2vec.pkl')
